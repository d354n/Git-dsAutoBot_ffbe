...
picBtnMainHomeExpedNewDoDuration3h              = folderffbeimage.."expeditions/btn_do_duration_3h.png"
picBtnMainHomeExpedNewDoDuration8h              = folderffbeimage.."expeditions/btn_do_duration_8h.png"
