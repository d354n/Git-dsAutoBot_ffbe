...
ActionExecVar(true)
ActionExecVar(4)
ActionExecVar(picBtnMapGrandLanzelt)
ActionExec(varActionExecuteDoWait)
ActionExecVar(0.5)
ActionExecWaitForm(varFormNameMapGrandLanzelt)

ActionOnForm(varFormNameMapGrandLanzelt)
...
ActionExecVar(varFormNameMapGrandLanzelt)  --13.action if on form
ActionExecVar(boxMaps)                --14.box
ActionExecVar(0.97)                   --15
ActionExecVar(picBtnMapGrandLanzeltLanzeltSnowfields)
