...
picBtnMainHomeArenaRulesSelectOppRatio07        = Pattern(folderffbeimage.."arena/btn_ratio_07.png"):similar(0.97)
picBtnMainHomeArenaRulesSelectOppRatio08        = Pattern(folderffbeimage.."arena/btn_ratio_08.png"):similar(0.97)
picBtnMainHomeArenaRulesSelectOppRatio09        = Pattern(folderffbeimage.."arena/btn_ratio_09.png"):similar(0.97)
picBtnMainHomeArenaRulesSelectOppRatio10        = Pattern(folderffbeimage.."arena/btn_ratio_10.png"):similar(0.97)
