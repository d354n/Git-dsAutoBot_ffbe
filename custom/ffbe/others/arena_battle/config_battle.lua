...
for j=1, 5 do
    ...
    ffbeBattleSwipeMagicAdd2(1, picBtnBattleMagicBlizzaga1, picBtnBattleAbilityGlacialWave1, picBtnBattleMagicAeroga2)
    ffbeBattleSwipeMagicAdd2(2, picBtnBattleAbilityDisorder1, picBtnBattleAbilityRicochet2)
    ...
    ffbeBattleSwipeMagicAdd2(5, picBtnBattleAbilityThunderFlask2, picBtnBattleAbilityBlizzardFlask1, picBtnBattleMagicBiora1)
