...
ActionExec(varActionExecuteDoClickButton)
ActionExecVar(critMainSummonOnceTapTop)
ActionExecWaitForm(varFormNameMainSummonOnceChar)

ActionOnForm(varFormNameMainSummonOnceChar)
ActionExec(varActionExecuteDoSaveSnapshot)
ActionExecVar(dateNowYYMMDDHM)
ActionExecVar(folderLogBattleResult.."log__summon_")
ActionExec(varActionExecuteDoClickButton)
ActionExecVar(critMainSummonOnceCharBottom)
ActionExecWaitForm(varFormNameMainSummonOnceChar)
